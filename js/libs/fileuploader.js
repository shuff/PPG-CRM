...
qq.FileUploaderBasic = function(o){
    ...
    this._options = {
        ...
        onComplete: function(id, fileName, responseJSON){refresh_files_list();},
...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' + 
                ...
                '<div class="qq-upload-button">&nbsp;&nbsp;&nbsp;Attach files</div>' +
...
{
//alert('fasd')
$('#grid').find('.files_list').each(function(e){
	//alert($(this).attr('id'));
var orders_id = $(this).attr('id').split('orders--attachments--upload--');
var orders_id = orders_id[1];
...
$('.img_x').click(function(){
	del_me($(this).attr('del_file'));
	show_files_list($(this).attr('orders_id'));
});
}
function del_me(del_file)
{
		var sendit = 'del_me=yes&del_file='+del_file;	
		var msg = $.ajax({
       	type: "POST",
        async: false,
        url: ".../functions.php",
