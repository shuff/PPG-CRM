...
class EMAIL_TO_DB {
	...
	var $attachments_path = '/home/shuff/ppg/files/email';
			...
			*/
			...
			function db_update(){
				...
				if($total_messages >= 1) {	//if there are emails in the mailbox
					...
					echo $this->msgid. "Starting with ".$this->msgid_start." out of ".$total_messages."<br>";
echo "$this->msgid /n";
					
					for($this->msgid = 1; $this->msgid <= $total_messages; $this->msgid++){
						echo $this->msgid ."/n". $this->msgid_start ."/n" . $total_messages . "/n";
						// *** TIME MEASUREMENT
						if(isset($startTime)){
